...
function Dashboard() {
  ...
  const fetchOrderData = async () => {
    try {
      const [clientResponse, productResponse, proposalResponse, newOrderResponse, wondata] = await Promise.all([
        axios.get("https://cedwenlms.onrender.com/api/cmdata"),
        axios.get("https://cedwenlms.onrender.com/api/userdata"),
        axios.get("https://cedwenlms.onrender.com/api/getNewproposal"),
        axios.get("https://cedwenlms.onrender.com/api/getNewOrder"),
        axios.get("https://cedwenlms.onrender.com/api/getwonData")
      ]);
  ...
  const handleDeleteorder = async (index) => {
    ...
    await axios.delete(`https://cedwenlms.onrender.com/api/deleteOrder/${idToDelete}`)
