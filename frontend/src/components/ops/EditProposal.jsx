...
function EditProposal() {
  ...
  const [formData, setFormData] = useState({
    ...
    buttonName: proposalData?.buttonName || [],
  });
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://cedwenlms.onrender.com/api/updateproposal/${id}`,
        formData
      );
     
      toast.success("Proposal Edit Successfully...", { autoClose: 2000 });
      if (formData.Status === "Won") {
        await axios.post(`https://cedwenlms.onrender.com/api/wonData/`, formData)
      }
      navigate("/ops");
    } catch (error) {
          ...
          <form onSubmit={handleFormSubmit}>
            <div className="bg-[#E8E8E8] px-4 text-sm max-xl:text-xs font-normal py-8 rounded-t-xl">
              <div className="">
                <div className=" flex items-center">
                  <p className="box-1  p-1  text-base max-xl:text-sm font-semibold text-gray-700 ">
                    Customer Name:{" "}
                  </p>
                  <p className="box-1  p-1 px-2 w-50 text-gray-900 font-normal text-sm max-xl:text-xs">
                    {formData.ClientName}
                  </p>
                </div>   
                ...
                <div className=" flex items-start">
                  ...
                  <p className="box-1 p-1 px-2 text-gray-900 font-normal text-sm max-xl:text-xs">
            ...
            <section className="px-4 py-8 border-b-2">
              ...
              <div className="grid grid-cols-5 max-xl:grid-cols-3 gap-5 pt-2">
                ...
                <div>
                  <label className="font-normal text-[#202020] text-sm">
                    City
                  </label>
                  <input
              ...
              <div className="overflow-x-auto">
                <table className="min-w-[100%] table-auto rounded-lg shadow-sm border border-separate border-spacing-0">
                  <thead className="bg-[#E84000] rounded-t-lg">
                    <tr>
                      <th className="px-4  whitespace-nowrap text-center py-[0.35rem] text-white text-sm max-xl:text-xs font-medium  border-b border-gray-300 rounded-tl-lg">
                        Sr No.
                      </th>
                      ...
                      <th className="px-6  whitespace-nowrap py-[0.35rem] text-white text-sm max-xl:text-xs font-medium text-center border-b border-gray-300">
                        Quantity
                      </th>
                      <th className="px-6  whitespace-nowrap py-[0.35rem] text-white text-sm max-xl:text-xs font-medium text-center border-b border-gray-300">
                        Rate
                      ...
                      <th className="px-6  whitespace-nowrap  py-[0.35rem] text-white text-sm max-xl:text-xs font-medium text-center border-b border-gray-300 rounded-tr-lg"></th>
                    </tr>
                  </thead>
            ...
            <section className="px-4 py-8 flex justify-between text-sm max-xl:text-xs font-normal">
              <div className="flex gap-3 items-end">
                {jobRole === "Super Admin" || jobRole === "Admin" ? (
                  ...
                  <>
                    {formData.buttonName === "Draft" ? (<>
                      <button
                        type="submit"
                        className="w-44 h-8 text-[#E84000] border-[#E84000] border rounded-md"
                      >
