...
function NewInvoive() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://cedwenlms.onrender.com/api/newinvoice", payload);
          ...
          <form onSubmit={handleFormSubmit}>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-[100%] table-auto rounded-lg shadow-sm border border-separate border-spacing-0">
                  <thead className="bg-[#E84000] rounded-t-lg">
                    <tr>
                      <th className="px-4 text-center py-[0.35rem] whitespace-nowrap text-white text--sm max-xl:text-xs font-medium  border-b border-gray-300 rounded-tl-lg">
                        Sr No.
                      </th>
            ...
            <section className="px-4 py-8 flex justify-between text-sm max-xl:text-xs font-normal">
              <div className="flex gap-3 items-end">
                <button
                  type="submit"
                  className="w-20 h-8 bg-[#E84000] text-white rounded-md"
                >
                  Save
                </button>
                <button
