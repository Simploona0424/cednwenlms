...
function Department() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (editingIndex !== null) {
            ...
            await axios.put(`https://cedwenlms.onrender.com/api/updatedepartment/${id}`, { name });
        ...
        try {
            const response = await axios.post("https://cedwenlms.onrender.com/api/savedepartment", { name });
    ...
    const handleDelete = async (index) => {
        ...
        try {
            await axios.delete(`https://cedwenlms.onrender.com/api/deletedepartment/${id}`);
