...
function ClientMaster() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingIndex !== null) {
      try {
        ...
        await axios.put(
          `https://cedwenlms.onrender.com/api/cmdata/${editingIndex}`,
          updatedcmProduct
        );
        setUserCMdata((prev) =>
          prev.map((item) =>
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`https://cedwenlms.onrender.com/api/cmdata/${id}`);
  ...
  const fetchOrderData = async () => {
    try {
      const response = await axios.get("https://cedwenlms.onrender.com/api/getNewOrder");
