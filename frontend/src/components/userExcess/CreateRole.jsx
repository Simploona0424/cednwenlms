...
function CreateRole() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get("https://cedwenlms.onrender.com/api/manageroleData");
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingIndex !== null) {
      try {
        ...
        await axios.put(
          `https://cedwenlms.onrender.com/api/manageroleData/${id}`,
          updatejobrole
        );
      ...
      try {
        const res = await axios.post("https://cedwenlms.onrender.com/api/manageroleData", { roleName });
  ...
  const handleDelete = async (index) => {
    try {
      ...
      await axios.delete(`https://cedwenlms.onrender.com/api/manageroleData/${id}`);
