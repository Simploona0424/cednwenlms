...
function OrderPage() {
    ...
    const HandleDeleteNewOrder = async (id) => {
        await axios.delete(`https://cedwenlms.onrender.com/api/deleteOrder/${id}`)
    ...
    const fetchOPSdata = async () => {
        try {
            const response = await axios.get("https://cedwenlms.onrender.com/api/getwonData")
    ...
    const handleDeletewonData = async (id) => {
        await axios.delete(`https://cedwenlms.onrender.com/api/deletewonData/${id}`)
