...
function Editorders() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.put(
                `https://cedwenlms.onrender.com/api/updateOrder/${id}`,
                formDataObj, {
                headers: {
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-[100%] table-auto rounded-lg shadow-sm border border-separate border-spacing-0">
                                    <thead className="bg-[#E84000] rounded-t-lg">
                                        <tr>
                                            <th className="px-3 text-center py-[0.35rem] text-white text-sm max-xl:text-xs whitespace-nowrap  font-medium  border-b border-gray-300 rounded-tl-lg">
                                                Sr No.
                                            </th>
                                        ...
                                        {formData.rows.map((row, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="text-center border-b border-gray-300">
                                                    <input
                                                        className="border h-8 border-gray-300 rounded-md px-3 text-end  text-sm max-xl:text-xs  focus:outline-none "
                                                        type="text"
                                                        placeholder="1.00"
                                    ...
                                    <div className="">
                                        ...
                                        <div className="flex items-center rounded-md border border-gray-300">
                                            ...
                                            <label
                                                ...
                                                className="flex items-center font-medium text-white text-sm max-xl:text-xs justify-center max-xl:w-80 gap-3 px-4 py-[0.35rem] bg-[#E84000] rounded-md shadow cursor-pointer hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2"
                                            >
                                ...
                                <div className="grid grid-cols-2 gap-5">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="flex items-center rounded-md border border-gray-300">
                                            ...
                                            <label
                                                htmlFor="invoicefile"
                                                className="flex items-center font-medium text-white text-sm max-xl:text-xs justify-center gap-3 max-xl:w-80 px-4 py-[0.35rem] bg-[#E84000] rounded-md shadow cursor-pointer hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2"
                                            >
                                                <i className="fa-solid fa-cloud-arrow-up"></i>
                                                Upload Doc
                                            </label>
