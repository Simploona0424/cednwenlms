...
function DCR() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (clientType === "New Client") {
        await axios.post("https://cedwenlms.onrender.com/api/cmdata", {
          companyName,
          clientID,
          fullName,
          emailId,
      ...
      await axios.post("https://cedwenlms.onrender.com/api/saveddcr", {
        companyName,
        clientID,
        fullName,
        emailId,
  ...
  const fetchDCRdata = async () => {
    try {
      const response = await axios.get("https://cedwenlms.onrender.com/api/getdcr");
  ...
  const handleDeleteProposal = async (id) => {
    try {
      await axios.delete(`https://cedwenlms.onrender.com/api/deletedcr/${id}`);
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      await axios.put(`https://cedwenlms.onrender.com/api/updatedcr/${editingIndex}`, {
        companyName,
        clientID,
        fullName,
        emailId,
